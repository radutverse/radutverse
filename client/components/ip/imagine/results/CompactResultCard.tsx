          ...
          <AnimatePresence>
            {showLicensingForm && (
              <>
                ...
                >
                  <div className="pointer-events-auto w-full max-w-md rounded-lg bg-slate-950 border-2 border-[#FF4DA6]/50 shadow-xl overflow-hidden max-h-[80vh] overflow-y-auto">
                    <LicensingForm
                      imageUrl={imageUrl}
                      type={type}
                      demoMode={demoMode}
