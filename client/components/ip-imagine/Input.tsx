          ...
          <textarea
            ...
            placeholder={
              !isInputFocused
                ? "Type to create…"
                : creationMode === "video"
                  ? "Type to create video (coming soon)…"
                  : "Type to create image…"
            }
            disabled={waiting}
          ...
          >
            ...
            <div className="relative flex-1">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 ${creationMode === "video" ? "bg-[#FF4DA6] text-white" : "bg-slate-800/50 text-slate-400 hover:bg-slate-800"}`}
              ...
              <span className="absolute -top-2 -right-2 inline-flex items-center gap-1 px-2 py-0.5 bg-amber-500 text-amber-950 text-xs font-bold rounded-full whitespace-nowrap">
                Coming Soon
              </span>
            </div>
          </motion.div>
